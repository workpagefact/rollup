...
pub const TYPE_LABELED_STATEMENT: [u8; 4] = 54u32.to_ne_bytes();
pub const TYPE_LITERAL_BIG_INT: [u8; 4] = 55u32.to_ne_bytes();
pub const TYPE_LITERAL_BOOLEAN: [u8; 4] = 56u32.to_ne_bytes();
pub const TYPE_LITERAL_NULL: [u8; 4] = 57u32.to_ne_bytes();
pub const TYPE_LITERAL_NUMBER: [u8; 4] = 58u32.to_ne_bytes();
pub const TYPE_LITERAL_REG_EXP: [u8; 4] = 59u32.to_ne_bytes();
pub const TYPE_LITERAL_STRING: [u8; 4] = 60u32.to_ne_bytes();
...
pub const TYPE_OBJECT_EXPRESSION: [u8; 4] = 66u32.to_ne_bytes();
pub const TYPE_OBJECT_PATTERN: [u8; 4] = 67u32.to_ne_bytes();
pub const TYPE_PRIVATE_IDENTIFIER: [u8; 4] = 68u32.to_ne_bytes();
...
pub const TYPE_RETURN_STATEMENT: [u8; 4] = 73u32.to_ne_bytes();
pub const TYPE_SEQUENCE_EXPRESSION: [u8; 4] = 74u32.to_ne_bytes();
pub const TYPE_SPREAD_ELEMENT: [u8; 4] = 75u32.to_ne_bytes();
pub const TYPE_STATIC_BLOCK: [u8; 4] = 76u32.to_ne_bytes();
pub const TYPE_SUPER_ELEMENT: [u8; 4] = 77u32.to_ne_bytes();
pub const TYPE_SWITCH_CASE: [u8; 4] = 78u32.to_ne_bytes();
pub const TYPE_SWITCH_STATEMENT: [u8; 4] = 79u32.to_ne_bytes();
pub const TYPE_TAGGED_TEMPLATE_EXPRESSION: [u8; 4] = 80u32.to_ne_bytes();
pub const TYPE_TEMPLATE_ELEMENT: [u8; 4] = 81u32.to_ne_bytes();
pub const TYPE_TEMPLATE_LITERAL: [u8; 4] = 82u32.to_ne_bytes();
pub const TYPE_THIS_EXPRESSION: [u8; 4] = 83u32.to_ne_bytes();
pub const TYPE_THROW_STATEMENT: [u8; 4] = 84u32.to_ne_bytes();
pub const TYPE_TRY_STATEMENT: [u8; 4] = 85u32.to_ne_bytes();
pub const TYPE_UNARY_EXPRESSION: [u8; 4] = 86u32.to_ne_bytes();
pub const TYPE_UPDATE_EXPRESSION: [u8; 4] = 87u32.to_ne_bytes();
pub const TYPE_VARIABLE_DECLARATION: [u8; 4] = 88u32.to_ne_bytes();
pub const TYPE_VARIABLE_DECLARATOR: [u8; 4] = 89u32.to_ne_bytes();
pub const TYPE_WHILE_STATEMENT: [u8; 4] = 90u32.to_ne_bytes();
pub const TYPE_YIELD_EXPRESSION: [u8; 4] = 91u32.to_ne_bytes();
