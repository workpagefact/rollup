...
pub const TYPE_JSX_EXPR_CONTAINER: [u8; 4] = 44u32.to_ne_bytes();
pub const TYPE_JSX_IDENTIFIER: [u8; 4] = 45u32.to_ne_bytes();
pub const TYPE_JSX_OPENING_ELEMENT: [u8; 4] = 46u32.to_ne_bytes();
pub const TYPE_JSX_TEXT: [u8; 4] = 47u32.to_ne_bytes();
pub const TYPE_LABELED_STATEMENT: [u8; 4] = 48u32.to_ne_bytes();
pub const TYPE_LITERAL_BIG_INT: [u8; 4] = 49u32.to_ne_bytes();
...
pub const TYPE_LITERAL_REG_EXP: [u8; 4] = 53u32.to_ne_bytes();
pub const TYPE_LITERAL_STRING: [u8; 4] = 54u32.to_ne_bytes();
pub const TYPE_LOGICAL_EXPRESSION: [u8; 4] = 55u32.to_ne_bytes();
pub const TYPE_MEMBER_EXPRESSION: [u8; 4] = 56u32.to_ne_bytes();
pub const TYPE_META_PROPERTY: [u8; 4] = 57u32.to_ne_bytes();
pub const TYPE_METHOD_DEFINITION: [u8; 4] = 58u32.to_ne_bytes();
pub const TYPE_NEW_EXPRESSION: [u8; 4] = 59u32.to_ne_bytes();
pub const TYPE_OBJECT_EXPRESSION: [u8; 4] = 60u32.to_ne_bytes();
pub const TYPE_OBJECT_PATTERN: [u8; 4] = 61u32.to_ne_bytes();
pub const TYPE_PRIVATE_IDENTIFIER: [u8; 4] = 62u32.to_ne_bytes();
pub const TYPE_PROGRAM: [u8; 4] = 63u32.to_ne_bytes();
pub const TYPE_PROPERTY: [u8; 4] = 64u32.to_ne_bytes();
pub const TYPE_PROPERTY_DEFINITION: [u8; 4] = 65u32.to_ne_bytes();
pub const TYPE_REST_ELEMENT: [u8; 4] = 66u32.to_ne_bytes();
pub const TYPE_RETURN_STATEMENT: [u8; 4] = 67u32.to_ne_bytes();
pub const TYPE_SEQUENCE_EXPRESSION: [u8; 4] = 68u32.to_ne_bytes();
pub const TYPE_SPREAD_ELEMENT: [u8; 4] = 69u32.to_ne_bytes();
pub const TYPE_STATIC_BLOCK: [u8; 4] = 70u32.to_ne_bytes();
pub const TYPE_SUPER_ELEMENT: [u8; 4] = 71u32.to_ne_bytes();
pub const TYPE_SWITCH_CASE: [u8; 4] = 72u32.to_ne_bytes();
pub const TYPE_SWITCH_STATEMENT: [u8; 4] = 73u32.to_ne_bytes();
pub const TYPE_TAGGED_TEMPLATE_EXPRESSION: [u8; 4] = 74u32.to_ne_bytes();
pub const TYPE_TEMPLATE_ELEMENT: [u8; 4] = 75u32.to_ne_bytes();
pub const TYPE_TEMPLATE_LITERAL: [u8; 4] = 76u32.to_ne_bytes();
pub const TYPE_THIS_EXPRESSION: [u8; 4] = 77u32.to_ne_bytes();
pub const TYPE_THROW_STATEMENT: [u8; 4] = 78u32.to_ne_bytes();
pub const TYPE_TRY_STATEMENT: [u8; 4] = 79u32.to_ne_bytes();
