...
pub const TYPE_UNARY_EXPRESSION: [u8; 4] = 74u32.to_ne_bytes();
pub const TYPE_UPDATE_EXPRESSION: [u8; 4] = 75u32.to_ne_bytes();
pub const TYPE_VARIABLE_DECLARATION: [u8; 4] = 76u32.to_ne_bytes();
pub const TYPE_VARIABLE_DECLARATOR: [u8; 4] = 77u32.to_ne_bytes();
pub const TYPE_WHILE_STATEMENT: [u8; 4] = 78u32.to_ne_bytes();
